...
Details on the classifier:
    The classifier used is based on a Roberta-base model trained for sentiment analysis on a big corpus of tweets available here :
    ...
    A picture of the used architecture is available in the zip folder (architecture.png)
